	...
	private String getAlarms(byte[] bytes) {
		...
		for (int i = 0; i < 48; i++) {
			if (bi.testBit(i)) {
				switch (i + 1 + "") {
				case "1":
					result = result + "FIRE & SMOKE" + ",";
					break;

				case "2":
					result = result + "DOOR OPEN" + ",";
					break;

				case "3":
					result = result + "MAINS FAIL" + ",";
					break;

				case "4":
					result = result + "GEN FAIL TO START" + ",";
					break;

				case "5":
					result = result + "GEN FAILED" + ",";
					break;

				case "6":
					result = result + "GEN EMERGENCY STOP" + ",";
					break;

				case "7":
					result = result + "GEN ALTERNATOR FAIL" + ",";
					break;

				case "8":
					result = result + "HCT ALARM" + ",";
					break;

				case "9":
					result = result + "BATTERY LVD" + ",";
					break;

				case "10":
					result = result + "SINGLE RECTIFIER FAIL" + ",";
					break;

				case "11":
					result = result + "GEN IDLE RUN" + ",";
					break;

				case "12":
					result = result + "GEN FAIL TO STOP" + ",";
					break;
				...
				case "14":
					result = result + "MULTIPLE RECTIFIER FAIL" + ",";
					break;

				case "15":
					result = result + "BATTERY FUSE FAIL" + ",";
					break;

				case "16":
					result = result + "LOAD FUSE FAIL" + ",";
					break;

				case "17":
					result = result + "AC1 FAIL" + ",";
					break;

				case "18":
					result = result + "AC2 FAIL" + ",";
					break;

				case "19":
					result = result + "NEUTRAL FAIL" + ",";
					break;

				case "21":
					result = result + "GEN OVERLOAD" + ",";
					break;

				case "22":
					result = result + "GEN MAX RUN TIME OVER" + ",";
					break;

				case "23":
					result = result + "ALT FAILED" + ",";
					break;

				case "24":
					result = result + "GEN BATTERY LOW" + ",";
					break;

				case "25":
					result = result + "LOW FUEL LEVEL" + ",";
					break;

				case "26":
					result = result + "ROOM TEMP HIGH" + ",";
					break;

				case "30":
					result = result + "GEN FREQ NOT MATCHING" + ",";
					break;

				case "31":
					result = result + "TAMPERING" + ",";
					break;
				}
			}
		}
	...
	private String getStatus(byte[] bytes) {
		...
		for (int i = 0; i < 48; i++) {
			if (bi.testBit(i)) {
				switch (i + 1 + "") {
				case "1":
					result = result + "Site on Battery" + ",";
					break;

				case "2":
					result = result + "Load on Mains" + ",";
					break;

				case "3":
					result = result + "MLoad on Gen" + ",";
					break;

				case "4":
					result = result + "Gen Healthy" + ",";
					break;

				case "5":
					result = result + "Mains OK" + ",";
					break;

				case "6":
					result = result + "SVR OK" + ",";
					break;

				case "7":
					result = result + "Gen Running" + ",";
					break;

				case "8":
					result = result + "IIPMS Auto Mode" + ",";
					break;

				case "9":
					result = result + "IIPMS Manual Mode" + ",";
					break;

				case "10":
					result = result + "Dynamic Load Shift" + ",";
					break;

				case "11":
					result = result + "EB Healthy" + ",";
					break;

				case "12":
					result = result + "Gen auto Mode" + ",";
					break;

				case "13":
					result = result + "Gen Manual Mode" + ",";
					break;
				}
			}
		}
